...
public class EquitySELLPage extends BasePage {

	public static String text;

	public static void Equity_sell(String excelName,String Scenario) throws Exception {
 ...
 //       Thread.sleep(1000);
        ...
        BasePage.scrollintoview("portfolio");
     ...
     BasePage.click1("transaction_code_click");
         ...
         BasePage.click1("code_dropdown_sell");
         Thread.sleep(2000);
  ...
  //       Thread.sleep(2000);
   ...
   //          Thread.sleep(2000);
	...
	public static void EquitySELL_FeesBreakdown_verification(String excelName,String Scenario) throws Exception {
...
public static void EquitySELL_DirectPlacement_verification(String excelName,String Scenario) throws Exception {
	...
	public static void EquityBuy_DirectPlacement_Submit() throws Exception {
     ...
     test.log(Status.INFO, "Verifying Direct Placement submit form");
    	BasePage.AssertProp("order_placement_assert","submit");
    	Thread.sleep(1000);
