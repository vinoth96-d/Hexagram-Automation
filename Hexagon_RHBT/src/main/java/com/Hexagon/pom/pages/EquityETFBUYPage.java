...
public class EquityETFBUYPage extends BasePage{
	
	public static String text;

	public static void Equity_ETFBUY(String excelName,String Scenario) throws Exception {
 ...
 //       Thread.sleep(1000);
  ...
  //     Thread.sleep(2000);
     ...
     BasePage.click1("transaction_code_click");
         ...
         BasePage.click1("code_dropdown_etfbuy");
        Thread.sleep(2000);
  ...
  //       Thread.sleep(2000);
   ...
   //          Thread.sleep(2000);
	...
	public static void EquityETF_FeesBreakdown_verification(String excelName,String Scenario) throws Exception {
 ...
 BasePage.horizontalRight();
	...
	public static void EquityETF_DirectPlacement_verification(String excelName,String Scenario) throws Exception {
