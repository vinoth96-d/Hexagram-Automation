...
public class EquityBUYPage extends BasePage {
	
	public static String text;

	public static void Equity_Buy(String excelName,String Scenario) throws Exception {
  ...
  //       Thread.sleep(2000);
   ...
   //          Thread.sleep(2000);
	...
	public static void EquityBUY_FeesBreakdown_verification(String excelName,String Scenario) throws Exception {
  ...
  /*  BasePage.horizontalRight();
	...
	public static void EquityBUY_DirectPlacement_verification(String excelName,String Scenario) throws Exception {
	...
	public static void EquityBuy_DirectPlacement_Submit(String excelName,String Scenario) throws Exception {
     ...
     test.log(Status.INFO, "Verifying Direct Placement submit form");
     BasePage.AssertExcel("order_placement_assert", "Submit", excelName, Scenario);
    	Thread.sleep(1000);
	...
	public static void EquityBUY_DirectPlacement_Confirmation(String excelName,String Scenario) throws Exception {
    	...
    	Thread.sleep(1000);
     	...
     	Thread.sleep(1000);
     	 ...
     	 test.log(Status.INFO, "Click on MOE Confirmation");
      	BasePage.click_hexgendash("moe_confirmation");
      	Thread.sleep(1000);
      	        	
      	
      	 test.log(Status.INFO, "Click on Checkbox");
      	 text="Checkbox";
       	BasePage.click_hexgendash("checkbox");
       	Thread.sleep(1000);
       	
        test.log(Status.INFO, "Click on Submit");
       	BasePage.click_hexgendash("submit_confirmation");
      
       	
       	test.log(Status.INFO, "Verifying Order Placement");
       	BasePage.AssertExcel("order_confirmation_assert", "Confirm", excelName, Scenario);
       	Thread.sleep(1000);
