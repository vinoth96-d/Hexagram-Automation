...
public class EquityETFSELLPage extends BasePage {

	public static String text;

	public static void Equity_ETFSELL(String excelName,String Scenario) throws Exception {
 ...
 //       Thread.sleep(1000);
     ...
     BasePage.click1("transaction_code_click");
         ...
         BasePage.click1("code_dropdown_etfsell");
         Thread.sleep(2000);
  ...
  //       Thread.sleep(2000);
   ...
   //          Thread.sleep(2000);
	...
	public static void EquityETFSELL_FeesBreakdown_verification(String excelName,String Scenario) throws Exception {
...
public static void EquityETFSELL_DirectPlacement_verification(String excelName,String Scenario) throws Exception {
