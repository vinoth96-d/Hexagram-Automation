...
public class MM_Partial_FutureDate_CHANGEINT extends BasePage{
	...
	public void Create_DepositPlacement() throws Exception
	{
		...
		test.log(Status.INFO, "MultiCurrency - Early Maturity(2 days) PartialWithdrawal(Future Date,Change in Interest)");
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(PartialWithdrawal,Change in INT)");
