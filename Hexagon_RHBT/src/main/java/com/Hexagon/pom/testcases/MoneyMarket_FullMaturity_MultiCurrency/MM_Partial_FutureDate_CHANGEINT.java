...
public class MM_Partial_FutureDate_CHANGEINT extends BasePage{
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(PartialWithdrawal,Change in INT,On Maturity)");
