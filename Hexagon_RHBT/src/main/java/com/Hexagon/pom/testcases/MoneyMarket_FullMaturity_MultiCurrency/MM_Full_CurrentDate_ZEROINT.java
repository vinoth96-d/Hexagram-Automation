package com.Hexagon.pom.testcases.MoneyMarket_FullMaturity_MultiCurrency;
...
public class MM_Full_CurrentDate_ZEROINT extends BasePage{
	...
	String Scenario = "MC CurrentDate(T+3) Zero INT";
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(FullWithdrawal,Zero INT,On Maturity)");
		 
		
		BulkDepositMaturityPage.BulkDepositMaturity_Fullwithdrawal(ExcelFileName, Scenario,"INT","MultiCurrency");
