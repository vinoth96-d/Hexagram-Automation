package com.Hexagon.pom.testcases.MoneyMarket_EarlyMaturity_SingleCurrency;
...
public class MM_Full_CurrentDate_ZEROINT extends BasePage{
	...
	String Scenario = "CurrentDate(T+2) Zero INT";
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(FullWithdrawal,Zero INT,Early Maturity)");
		 
		
		BulkDepositMaturityPage.BulkDeposit_EarlyMaturity_Fullwithdrawal(ExcelFileName, Scenario,"INT","");
