...
import com.Hexagon.pom.util.SendMail;
import com.aventstack.extentreports.ExtentReports;
import com.aventstack.extentreports.reporter.ExtentHtmlReporter;
import com.aventstack.extentreports.reporter.configuration.Theme;

public class Subred_CurrentDateTest extends BaseProjectMethods{
	...
	{
		test=extent.createTest("Create Manual Portfolio Subscription on CurrentDate with settlement date(T+1)");
		//Save Excel
		
		
		LoginPage.Launch_application("HexagonURL");
		LoginPage.Reset(ExcelFileName, "CurrentDate(T+1) UNSAL");
		

		LoginPage.do_login(ExcelFileName,"CurrentDate(T+1) UNSAL");
		

		Portfolio_SubRed.Portfolio_subscription_T1(ExcelFileName, "CurrentDate(T+1) UNSAL");
		Portfolio_SubRed.PortfolioSubscription_Submit(ExcelFileName, "CurrentDate(T+1) UNSAL");
	...
	public void Approve_PortfolioSubscriptionT1() throws Exception
	{
		...
		Portfolio_SubRed.PortfolioSubred_Confirmation(ExcelFileName, "CurrentDate(T+1) UNSAL","TransactionID1");
	...
	{
		test=extent.createTest("Create Manual Portfolio Subscription on CurrentDate with settlement date(T+2)");
		
		
		LoginPage.do_login(ExcelFileName,"CurrentDate(T+2) UNSAL");
		
		Portfolio_SubRed.Portfolio_subscription_T2(ExcelFileName, "CurrentDate(T+2) UNSAL");
		Portfolio_SubRed.PortfolioSubscription_Submit(ExcelFileName, "CurrentDate(T+2) UNSAL");
...
test=extent.createTest("Approve Portfolio Subscription");
		...
		Portfolio_SubRed.PortfolioSubred_Confirmation(ExcelFileName, "CurrentDate(T+2) UNSAL","TransactionID2");
	...
	{
		test=extent.createTest("Create Manual Portfolio Redemption on CurrentDate with settlement date(T+0)");
		
		LoginPage.do_login(ExcelFileName,"CurrentDate(T+0) UNPUR");
		
		Portfolio_SubRed.Portfolio_subscription_T0(ExcelFileName, "CurrentDate(T+0) UNPUR");
		Portfolio_SubRed.PortfolioSubscription_Submit(ExcelFileName, "CurrentDate(T+0) UNPUR");
	...
	public void Approve_PortfolioSubscriptionT0() throws Exception
	{
		...
		Portfolio_SubRed.PortfolioSubred_Confirmation(ExcelFileName, "CurrentDate(T+0) UNPUR","TransactionID3");
	...
	{
		test=extent.createTest("Upload Subred Excel File on CurrentDate with Settlement Date(T+1,T+2,T+0)");

		
		LoginPage.do_login(ExcelFileName,"CurrentDate Upload Subred");
		
		Portfolio_SubRed.Upload_Subred(ExcelFileName, "CurrentDate Upload Subred","CurrentDate");
	...
	@Test(priority = 8)
		public void Approve_Uploaded_PortfolioSubred() throws Exception
		{
			...
			Portfolio_SubRed.UploadPortfolioSubred_Confirmation(ExcelFileName, "CurrentDate Upload Subred");
	...
	@Test(priority = 9)
		public void Verify_SubscriptionRedemption_Report() throws Exception
		{
			...
			LoginPage.do_login(ExcelFileName,"CurrentDate SubRed Report");
			Portfolio_SubRed.Verifying_SubscriptionRedemption_Report(ExcelFileName, "CurrentDate SubRed Report");
	...
	public void PortfolioSubred_Cancellation() throws Exception
	{
		test=extent.createTest("Portfolio Subred Cancellation of Uploaded transaction");
			...
			Portfolio_SubRed.UploadedSub_cancellation_T2(ExcelFileName, "CurrentDate Upload Subred","TransactionID5");
	...
	public void Approve_Subred_Cancellation() throws Exception
	{
		...
		Portfolio_SubRed.ApproveUploadedSub_cancellation_T2(ExcelFileName, "CurrentDate Upload Subred");
	...
	public void ManualNAVClosing_Intraday() throws Exception
	{
		...
		LoginPage.do_login(ExcelFileName,"CurrentDate Upload Subred");
		Portfolio_SubRed.Manual_NAVClosing(ExcelFileName, "CurrentDate Upload Subred");
	...
	public void View_AccountingEnquiry_Report() throws Exception
	{
		...
		Portfolio_SubRed.Verifying_AccountingEnquiry_Report(ExcelFileName, "CurrentDate SubRed Report");
	...
	@Test(priority = 14)
			public void ManualNAVclosing_Intraday_Freeze() throws Exception
			{
				...
				Portfolio_SubRed.ManualNAVClosing_IntradayFreeze(ExcelFileName, "CurrentDate(T+1) UNSAL");
	...
	public void Create_FullSettlement() throws Exception
	{
		...
		Portfolio_SubRed.Full_settlement(ExcelFileName, "CurrentDate(T+1) UNSAL","TransactionID1","");
	...
	public void Approve_FullSettlement() throws Exception
	{
		...
		Portfolio_SubRed.Approve_Settlement(ExcelFileName, "CurrentDate SubRed Report");
	...
	@Test(priority = 17)
		public void Create_PartialSettlement() throws Exception
		{
			...
			LoginPage.do_login(ExcelFileName,"CurrentDate SubRed Report");
			Portfolio_SubRed.Partial_settlement_T1(ExcelFileName, "CurrentDate(T+1) UNSAL");
	...
	public void Verify_BankTransactions_Report() throws Exception
	{
		...
		LoginPage.do_login(ExcelFileName,"CurrentDate SubRed Report");
		Portfolio_SubRed.Verifying_BankTransactions_Report(ExcelFileName, "CurrentDate(T+1) UNSAL","Debit");
		...
		public void FullSettlement_Reversal() throws Exception
		{
			...
			Portfolio_SubRed.Full_settlement_Reversal(ExcelFileName, "CurrentDate SubRed Report","TransactionID1");
		...
		public void Approve_FullSettlement_Reversal() throws Exception
		{
		 ...
		 @Test(priority = 22)
			public void PartialSettlement_Reversal() throws Exception
			{
				...
				LoginPage.do_login(ExcelFileName,"CurrentDate SubRed Report");
				Portfolio_SubRed.Partial_settlement_Reversal(ExcelFileName, "CurrentDate SubRed Report");
			...
			public void Verify_BankTransactions_report() throws Exception
			{
				...
				LoginPage.do_login(ExcelFileName,"CurrentDate SubRed Report");
				Portfolio_SubRed.Verifying_BankTransactions_Report(ExcelFileName, "CurrentDate(T+1) UNSAL","Credit");
			...
			public void Create_Full_Settlement() throws Exception
			{
				...
				Portfolio_SubRed.Full_settlement(ExcelFileName, "CurrentDate(T+1) UNSAL","TransactionID1","TransactionID4");
			...
			public void PortfolioSubred_cancellation() throws Exception
			{
				...
				LoginPage.do_login(ExcelFileName,"CurrentDate Upload Subred");
					Portfolio_SubRed.Subred_cancellation_T1(ExcelFileName, "CurrentDate Upload Subred");
			...
			public void ManualNAVClosing_Intraday_Freeze() throws Exception
			{
				...
				Portfolio_SubRed.ManualNAVClosing_IntradayFreeze(ExcelFileName, "CurrentDate(T+2) UNSAL");
			...
			@Test(priority = 29)
					public void Create_FullSettlementT2() throws Exception
					{
						...
						Portfolio_SubRed.Full_settlement(ExcelFileName, "CurrentDate(T+2) UNSAL","TransactionID2","");
		   ...
		   @Test(priority = 31)
			public void FullSettlement_ReversalT2() throws Exception
			{
				...
				LoginPage.do_login(ExcelFileName,"CurrentDate SubRed Report");
				Portfolio_SubRed.Full_settlement_Reversal(ExcelFileName, "CurrentDate SubRed Report","TransactionID2");
			...
			public void PortfolioSubred_CancellationT2() throws Exception
			{
				...
				LoginPage.do_login(ExcelFileName,"CurrentDate Upload Subred");
					Portfolio_SubRed.UploadedSub_cancellation_T2(ExcelFileName, "CurrentDate Upload Subred","TransactionID2");
			...
			public void Rebuild_NAV() throws Exception
			{
				...
				LoginPage.do_login(ExcelFileName,"CurrentDate Upload Subred");
				Portfolio_SubRed.RebuildNAV(ExcelFileName, "CurrentDate(T+1) UNSAL");
			...
			public void Verify_NAVSummary_Report() throws Exception
			{
				...
				Portfolio_SubRed.Verifying_NAVSummary_Report(ExcelFileName, "CurrentDate SubRed Report");
