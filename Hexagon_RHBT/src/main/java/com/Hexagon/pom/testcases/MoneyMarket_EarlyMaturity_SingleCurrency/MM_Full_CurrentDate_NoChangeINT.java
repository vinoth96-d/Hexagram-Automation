...
public class MM_Full_CurrentDate_NoChangeINT extends BasePage{
	...
	String Scenario = "CurrentDate(T+2) No change INT";
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(FullWithdrawal,No Change in INT,Early Maturity)");
		 
		
		BulkDepositMaturityPage.BulkDeposit_EarlyMaturity_Fullwithdrawal(ExcelFileName, Scenario,"","");
