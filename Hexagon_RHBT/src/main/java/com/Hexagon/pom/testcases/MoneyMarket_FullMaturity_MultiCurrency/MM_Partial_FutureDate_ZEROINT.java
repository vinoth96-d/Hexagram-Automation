...
public class MM_Partial_FutureDate_ZEROINT extends BasePage{

    
	String ExcelFileName = BasePage.readURLTestDataProp("MoneyMarket_TestData");
	
	String Scenario = "MC FutureDate(T+3) Zero INT";
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(PartialWithdrawal,Zero INT,On Maturity)");
