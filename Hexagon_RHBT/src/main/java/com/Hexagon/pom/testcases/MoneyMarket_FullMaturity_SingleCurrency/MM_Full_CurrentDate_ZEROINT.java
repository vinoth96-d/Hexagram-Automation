package com.Hexagon.pom.testcases.MoneyMarket_FullMaturity_SingleCurrency;
...
public class MM_Full_CurrentDate_ZEROINT extends BasePage{
	...
	String Scenario = "CurrentDate(T+3) Zero INT";
	...
	public void Create_BulkDepositMaturity() throws Exception
	{
		...
		BulkDepositMaturityPage.BulkDepositMaturity_Fullwithdrawal(ExcelFileName, Scenario,"INT","");
