...
public class MM_Partial_CurrentDate_CHANGE_INT extends BasePage{
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(PartialWithdrawal,Change in INT,Early Maturity)");
		
		BulkDepositMaturityPage.BulkDeposit_EarlyMaturity(ExcelFileName, Scenario,"INT","");
