...
public class MM_Full_BackDate_ChangeINT extends BasePage{

    
	String ExcelFileName = BasePage.readURLTestDataProp("MoneyMarket_TestData");
	
	String Scenario = "MC BackDate(T+2) change INT";
	
	@Test(priority = 1)
	public void Create_DepositPlacement() throws Exception
	{
		test=extent.createTest("Create Deposit Placement on BackDate");
			test.log(Status.INFO, "MultiCurrency -Early Maturity(2 days) Full Withdrawal(Back Date,Change in Interest)");
