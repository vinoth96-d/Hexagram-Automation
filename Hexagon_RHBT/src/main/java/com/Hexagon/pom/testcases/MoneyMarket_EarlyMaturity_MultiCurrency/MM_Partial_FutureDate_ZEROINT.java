...
public class MM_Partial_FutureDate_ZEROINT extends BasePage{
	...
	public void Create_DepositPlacement() throws Exception
	{
		...
		test.log(Status.INFO, "MultiCurrency - Early Maturity(2 days) PartialWithdrawal(Future Date,Zero Interest)");
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(PartialWithdrawal,Zero INT)");
