...
public class MM_Full_CurrentDate_ChangeINT extends BasePage{

    
	String ExcelFileName = BasePage.readURLTestDataProp("MoneyMarket_TestData");
	String Scenario = "MC CurrentDate(T+2) change INT";
	...
	public void Create_DepositPlacement() throws Exception
	{
		...
		test.log(Status.INFO, "MultiCurrency -Early Maturity(2 days) FullWithdrawal(Current Date,Change in Interest)");
