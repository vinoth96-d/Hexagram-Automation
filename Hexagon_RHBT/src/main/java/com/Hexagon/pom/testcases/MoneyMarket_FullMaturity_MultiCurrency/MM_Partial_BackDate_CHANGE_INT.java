...
public class MM_Partial_BackDate_CHANGE_INT extends BasePage{
	...
	public void Create_DepositPlacement() throws Exception
	{
		...
		// test.assignCategory("MultiCurrency - Partial Withdrawal(Back Date, Change in Interest");
	...
	{
		test=extent.createTest("Create Bulk Deposit Maturity(PartialWithdrawal,No Change in INT,On Maturity)");
		
		BulkDepositMaturityPage.BulkDepositMaturity(ExcelFileName, Scenario,"INT","MultiCurrency");
